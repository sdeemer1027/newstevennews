<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-black dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('food.menu')" :active="request()->routeIs('food.menu')">
                        {{ __('Food') }}
                    </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4
                                       font-medium rounded-md text-white dark:text-white-400 bg-black dark:bg-gray-800
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('foodfact.index')">
                            {{ __('FoodFacts') }}
                        </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('food.menu')">
                    {{ __('Food') }}
                </x-responsive-nav-link>
