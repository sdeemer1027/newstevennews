            ...
            <div class="container">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
                        <div class="content d-flex flex-column justify-content-center text-white">
        ...
        <section id="services" class="services">
            <div class="container">
                ...
                <div class="row  text-white">
                    <div class="col-lg-4 col-md-6 icon-box  text-white">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        <div class="box">
                            ...
                            <h4>DataBase</h4>
                            <p>
                                From DataStorage to Relational Data Structure <BR><BR>" Select Me From your_selection; " <BR>
                            </p>
                            ...
                            <div class="member-info">
                                <div class="member-info-content">
                                    ...
                                    <div class="social">
                                        ...
                                        <a href="https://www.instagram.com/sd1964.with/" target="_new"><i class="bi bi-instagram"></i></a>
                                        <a href="https://www.linkedin.com/in/steven-deemer/" target="_new"><i class="bi bi-linkedin"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
