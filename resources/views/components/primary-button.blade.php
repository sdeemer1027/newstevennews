<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex items-center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-transparent rounded-md
               font-semibold text-xs text-black dark:text-gray-800 uppercase tracking-widest hover:bg-gray-700
               dark:hover:bg-black hover:text-white dark:hover:text-white focus:bg-gray-700 dark:focus:bg-black
